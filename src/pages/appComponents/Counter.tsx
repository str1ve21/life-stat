...
const Counter = observer((props: IProps) => {
  ...
  return (
    ...
    >
      ...
      ></CounterMenu>
      <div className="flex flex-col justify-between h-full counter-padding leading-none bg-white rounded-2xl duration-[2000ms] transition-colors">
        <div>
          <h2
        ...
        <p
          className="counter-value mt-[20px] mb-[10px] break-words text-justify"
