...
export default function WelcomePage() {
  const createCounterDialog: ICounterDialog = {
    ...
    title:
      "Здесь вы можете создать новый счётчик со своими параметрами, и кастомизировать его. Необязательными являются заголовок, описание и цель. Стандартное значение ввода изменяется только после перезагрузки страницы.",
    buttonText: "Создать",
    isEdit: false,
  };
