...
export default function WelcomePage() {
  ...
  return (
    <section className="grid place-content-center min-h-[420px] h-[50vh] content-padding bg-neutral-100 dark:bg-neutral-800 round rounded-t-none overflow-hidden">
      <div
        id="hello-content"
